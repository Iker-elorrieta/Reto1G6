...
public class Conexion {
    ...
    public static Firestore conectar() throws IOException {
        ...
        Firestore fs = null;
        try {
            // Comprobación rápida de red: intentamos conectar al host de Firestore con un timeout corto.
            ...
            try (Socket sock = new Socket()) {
                ...
                System.err.println("Sin conexión o no se puede alcanzar firestore.googleapis.com: " + netEx.getMessage());
                return null;
            }
